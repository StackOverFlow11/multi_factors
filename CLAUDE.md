...
- ✅ 质量门：`pytest` **484 passed**（P0=97 / P1=78 / P2-1=22 / P2-2=22 / P2-3=14 / P2-4=8 / P3-1=10 / P3-2=18 / P3-3=16 / P3-4=15 / P3-5=22 / P3-6=27 / P3-7=25+1 throttle / P3-8=8 / P4-1=28 / P4-2=17 / **intraday I1 schema=14 + feed=9 / I2 cache=10 / I3 aggregate=13 / I4 execution=10**）；`ruff` clean；`validate-config`（全部 12 配置）+ `run-phase0`（demo）均 OK（**ic 0.9600 / annual 0.8408 不变**）。
...
- 路线图下一步：**P4-3 因子支撑端点缓存**（fina_indicator/daily_basic/index_member_all）——暖跑剩余 live 抓取即这三端点；**分钟级轨道 I5**（把 EXPLORATORY 分钟因子端到端接 I2→I3→I4，opt-in config，日频回归不破）；研究侧：更长 holdout 滚动复检 / 中证1000 / 成本模型细化。
